...
public class ProdSubCatAdapter extends RecyclerView.Adapter<ProdSubCatAdapter.MyViewHolder> {
    Context context;
    private List<ProdSubCat> ofertasList;
    private final OnItemClickListener listener;
    Producto producto;

    public ProdSubCatAdapter(List<ProdSubCat> ofertasList, Context context, OnItemClickListener listener, Producto producto) {
    ...
    public void updateData(List<ProdSubCat> ofertasList) {
        this.ofertasList = ofertasList;
    }

    @NonNull
    @Override
    public ProdSubCatAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.seleccion_prod_listados, viewGroup, false);
        return new ProdSubCatAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ProdSubCatAdapter.MyViewHolder holder, final int position) {
        ProdSubCat item = ofertasList.get(position);
