...
public class ProdOpcionesAdapter extends RecyclerView.Adapter<ProdOpcionesAdapter.MyViewHolder> {
    Context context;
    private List<ProdOpciones> ofertasList;
    private final OnItemClickListener listener;
    Producto producto;

    public ProdOpcionesAdapter(List<ProdOpciones> ofertasList, Context context, OnItemClickListener listener, Producto producto) {
    ...
    public void updateData(List<ProdOpciones> ofertasList) {
        this.ofertasList = ofertasList;
    }

    @NonNull
    @Override
    public ProdOpcionesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.seleccion_prod_listados, viewGroup, false);
        return new ProdOpcionesAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ProdOpcionesAdapter.MyViewHolder holder, final int position) {
        ProdOpciones item = ofertasList.get(position);
