...
public class ProductoResumenAdapter extends CardSliderAdapter<ProductoResumenAdapter.ProductoViewHolder> {


    private ArrayList<Producto> movies;
    Context context;
    private final OnItemClickListener listener;

    public ProductoResumenAdapter(ArrayList<Producto> movies, Context context, OnItemClickListener listener) {
        this.movies = movies;
    ...
    public ProductoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_prod_resumen, parent, false);
