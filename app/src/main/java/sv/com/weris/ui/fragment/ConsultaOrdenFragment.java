...
import sv.com.weris.ui.adapter.OrdenAdapter;

// Instances of this class are fragments representing a single
// object in our collection.
public class ConsultaOrdenFragment extends Fragment {
    ...
    public ConsultaOrdenFragment() {
    }

    public ConsultaOrdenFragment(Cliente cliente) {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_consulta_orden, container, false);
    }
    ...
    public void obtenerOrdenes() {
        ...
        Call<List<Pedido>> call = servicesAPI.ordenesPorCliente(cliente.getClientePK().getIdCompania(), cliente.getClientePK().getId(), 1);
